...
item replace block ~ ~ ~ container.16 with minecraft:firework_star{CustomModelData:9102025,display:{Name:"{\"translate\":\"item.cnc.crafting_table_output\"}"},CNC_bg:1b,Output:1b}
