...
item replace block ~ ~ ~ container.16 with minecraft:firework_star{CustomModelData:9102025,display:{Name:"{\"translate\":\"item.cam.sacrificing_table\"}"},CAM_bg:1b,Output:1b}
