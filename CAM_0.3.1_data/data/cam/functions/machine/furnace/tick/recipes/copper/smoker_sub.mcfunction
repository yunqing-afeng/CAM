...
execute store result score @s CAM_copper_time run data get block ~ ~ ~ CookTime
tag @s add CAM_fur_copper_temp
data modify block ~ ~ ~ Items[{Slot:0b}].id set value "minecraft:potato"
data remove block ~ ~ ~ Items[{Slot:2b}]
schedule function cam:machine/furnace/tick/recipes/copper/smoker_sch 2t
