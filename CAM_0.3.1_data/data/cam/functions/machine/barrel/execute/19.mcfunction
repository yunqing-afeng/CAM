data modify block ~ 319 ~ Items[{Slot:0b}].id set from block ~ 319 ~ Items[{Slot:19b}].id
data modify block ~ 319 ~ Items[{Slot:0b}].tag set from block ~ 319 ~ Items[{Slot:19b}].tag
...
data modify block ~ ~ ~ Items[{Slot:19b}].id set from block ~ 319 ~ Items[{Slot:0b}].id
data modify block ~ ~ ~ Items[{Slot:19b}].tag set from block ~ 319 ~ Items[{Slot:0b}].tag
