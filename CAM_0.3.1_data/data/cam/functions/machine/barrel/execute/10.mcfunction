data modify block ~ 319 ~ Items[{Slot:0b}].id set from block ~ 319 ~ Items[{Slot:10b}].id
data modify block ~ 319 ~ Items[{Slot:0b}].tag set from block ~ 319 ~ Items[{Slot:10b}].tag
...
data modify block ~ ~ ~ Items[{Slot:10b}].id set from block ~ 319 ~ Items[{Slot:0b}].id
data modify block ~ ~ ~ Items[{Slot:10b}].tag set from block ~ 319 ~ Items[{Slot:0b}].tag
