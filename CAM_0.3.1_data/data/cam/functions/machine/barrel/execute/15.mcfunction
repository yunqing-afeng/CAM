data modify block ~ 319 ~ Items[{Slot:0b}].id set from block ~ 319 ~ Items[{Slot:15b}].id
data modify block ~ 319 ~ Items[{Slot:0b}].tag set from block ~ 319 ~ Items[{Slot:15b}].tag
...
data modify block ~ ~ ~ Items[{Slot:15b}].id set from block ~ 319 ~ Items[{Slot:0b}].id
data modify block ~ ~ ~ Items[{Slot:15b}].tag set from block ~ 319 ~ Items[{Slot:0b}].tag

data remove block ~ 319 ~ Items[{Slot:0b}].tag
data remove block ~ 319 ~ Items[{Slot:15b}]