data modify block ~ 319 ~ Items[{Slot:0b}].id set from block ~ 319 ~ Items[{Slot:26b}].id
data modify block ~ 319 ~ Items[{Slot:0b}].tag set from block ~ 319 ~ Items[{Slot:26b}].tag
...
data modify block ~ ~ ~ Items[{Slot:26b}].id set from block ~ 319 ~ Items[{Slot:0b}].id
data modify block ~ ~ ~ Items[{Slot:26b}].tag set from block ~ 319 ~ Items[{Slot:0b}].tag

data remove block ~ 319 ~ Items[{Slot:0b}].tag
data remove block ~ 319 ~ Items[{Slot:26b}]