setblock ~ 319 ~ shulker_box{Items:[{Slot:0b,id:"minecraft:suspicious_stew",Count:1b,tag:{display:{Name:"{\"translate\":\"item.cam.error_stew\",\"italic\":\"false\"}"},CustomModelData:9102127,id:"cam:error_stew",Effects:[{EffectId:0,EffectDuration:200},{EffectId:1,EffectDuration:200},{EffectId:2,EffectDuration:200},{EffectId:3,EffectDuration:200},{EffectId:4,EffectDuration:200}]}}]}
