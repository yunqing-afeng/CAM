data modify block ~ 319 ~ Items[0].id set from entity @s Inventory[{Slot:-106b}].id
data modify block ~ 319 ~ Items[0].Count set from entity @s Inventory[{Slot:-106b}].Count
data modify block ~ 319 ~ Items[0].tag set from entity @s Inventory[{Slot:-106b}].tag
