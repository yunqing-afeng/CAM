data modify block ~ 319 ~ Items[0].id set from entity @s Inventory[{Slot:3b}].id
data modify block ~ 319 ~ Items[0].Count set from entity @s Inventory[{Slot:3b}].Count
data modify block ~ 319 ~ Items[0].tag set from entity @s Inventory[{Slot:3b}].tag
...
loot replace entity @s hotbar.3 1 mine ~ 319 ~ minecraft:diamond_pickaxe{isShulkerMarker:1b}