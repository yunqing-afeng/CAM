...
data modify storage cam:villager hunter.A.buy merge from entity @e[type=minecraft:item,sort=nearest,tag=CAM_temp1,limit=1] Item
data modify storage cam:villager hunter.A.sell merge from entity @e[type=minecraft:item,sort=nearest,tag=CAM_temp2,limit=1] Item
