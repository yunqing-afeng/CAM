...
execute if score attack_knockback temp matches 0 run function cam:knockback/3
execute unless score attack_knockback temp matches 0 run function cam:knockback/4
