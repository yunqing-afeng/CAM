advancement revoke @s only cam:countryside_and_magic/palace_lantern
...
execute unless entity @e[type=area_effect_cloud,distance=..7,tag=CAM_block_pos] positioned ~ ~-1 ~ anchored eyes run function cam:cm/palace_lantern/ray_armor_stand
execute at @e[type=area_effect_cloud,distance=..7,tag=CAM_block_pos] run function cam:cm/palace_lantern/put
